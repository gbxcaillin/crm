...
function features() { return { mail: mail.enabled(), mailMode: mail.mode(), sharepoint: graph.enabled(), mailbox: require('./mailbox').enabled(), market: true, push: true, webAnalytics: cloudflare.enabled(), aiAssist: claude.enabled(), demo: process.env.DEMO_DATA === '1' }; }
