...
const COLS = { deals: 'id', tasks: 'id', clients: 'id', invoices: 'id', events: 'id', messages: 'id', rooms: 'id', threads: 'id', files: 'id', notifs: 'id', activity: 'id', changes: 'id', models: 'id', subscribers: 'id', sequences: 'id', enrolments: 'id', securities: 't' };
