...
const cfg = {
  ...
  from: env.MAIL_FROM || 'GBX Pipeline <no-reply@gbxps.com>',
...
<tr><td style="padding:14px 28px;border-top:1px solid #E4DFD3;font-size:11px;color:#8E8B83">${footer || `GBX Professional Services · sent by the Pipeline app. Notification preferences: ${BASE}/#/settings/notifications`}</td></tr>
